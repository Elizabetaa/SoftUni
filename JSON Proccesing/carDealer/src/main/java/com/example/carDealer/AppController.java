...
public class AppController implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //Query2
        System.out.println(this.carService.getCarByMake());
        //Query3
        System.out.println(this.supplierService.getAllSuppliers());
        //Query4
        System.out.println(this.carService.getCarsWithParts());
        //Query5
        System.out.println(this.customerService.getAllWithBoughtCars());
        //Query6
        System.out.println(this.saleService.getSalesWithAndWithoutDiscount());
